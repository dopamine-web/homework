...
// numbers2.forEach(); используется для перебора элементов массива
...
// Пример: "dlrow".split("") → ['d', 'l', 'r', 'o', 'w']

// 2️ .reverse()

// Разворачивает массив в обратном порядке.

// Пример: ['d', 'l', 'r', 'o', 'w'].reverse() → ['w', 'o', 'r', 'l', 'd']

// 3️ .join("")

// Собирает массив обратно в строку, соединяя элементы без разделителя ("").

// Пример: ['w', 'o', 'r', 'l', 'd'].join("") → "world"

.charAt // Он возвращает символ строки по указанной позиции (индексу).Индексы начинаются с 0 (первый символ — индекс 0, второй — 1 и т.д.).
//берём первую букву имени (charAt(0)) и проверяем, равна ли она "R" или "r".